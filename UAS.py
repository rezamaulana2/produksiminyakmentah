...
df = pd.read_csv("D:/Documents/Tugas/Code Python/UAS/produksi_minyak_mentah.csv")
f=open("D:/Documents/Tugas/Code Python/UAS/kode_negara_lengkap.json")
data=json.load(f)
...
df1.plot(kind="line",x="tahun",y="produksi",title="Jumlah Produksi Minyak Mentah "+name+" terhadap Waktu(Tahun)")
plt.show()

sorted_value = df.sort_values(["produksi"], ascending=[0])
tahun = int(input("Masukkan Tahun : "))
while tahun < 1971 or tahun > 2015:
    print("Maaf, Tahun tidak ditemukan. Tolong masukkan Tahun yang valid.")
    tahun = int(input("Masukkan Tahun : "))

data_tahun = sorted_value.loc[sorted_value["tahun"]==tahun]
jumlah_negara = int(input("Masukkan Jumlah Negara : "))
while jumlah_negara <1 or jumlah_negara>100:
    print("Tolong masukkan jumlah negara yang valid.")
    jumlah_negara = int(input("Masukkan Jumlah Negara : "))
