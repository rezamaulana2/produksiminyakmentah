...
df = pd.read_csv("https://github.com/rezamaulana2/produksiminyakmentah/blob/main/produksi_minyak_mentah.csv")
f=open("https://github.com/rezamaulana2/produksiminyakmentah/blob/main/kode_negara_lengkap.json")
data=json.load(f)
