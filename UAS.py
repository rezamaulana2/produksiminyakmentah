...
st.markdown("Jumlah Produksi Minyak Mentah Terbesar pada Tahun "+str(tahun)+" adalah : ")
...
st.markdown("Jumlah Produksi Minyak Mentah Terbesar pada Tahun Kumulatif adalah : ")
st.markdown("Negara      : "+nama)
st.markdown("Kode Negara : "+kode_negara)
st.markdown("Region      : "+region)
st.markdown("Sub Region  : "+sub_region)
...
st.markdown("Jumlah Produksi Minyak Mentah Terkecil pada Tahun Kumulatif adalah : ")
st.markdown("Negara      : "+nama)
st.markdown("Kode Negara : "+kode_negara)
st.markdown("Region      : "+region)
st.markdown("Sub Region  : "+sub_region)
...
st.markdown("Jumlah Produksi Minyak Mentah 0.0 pada Tahun "+str(tahun)+" adalah : ")
...
st.markdown("Jumlah Produksi Minyak Mentah 0.0 pada Kumulatif Tahun adalah : ")
dic_df0 = dict()
